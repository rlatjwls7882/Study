...
int isLeapYear(int year); //지정된 year가 윤년(leap year0이면 1, 아니면 0을 반환
...
int dateToDay(int year,int month, int day){
	...
	int numOfLeapYear=0; //운년의 수
	int daySumToLastYear=0; //1년 1월 1일부터 전년도까지의 일수
	int daySumToLastMonth=0; //해당 년도의 1월 1일부터 전달까지의 일수
	int i;
