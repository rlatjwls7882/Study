...
<table class="table table-bordered td-center">
	<tbody>
		<tr>
			<td><img alt="" src="" style="width: 154px; height: 156px;"></td>
			<td><img alt="" src="" style="width: 158px; height: 157px;"></td>
			<td><img alt="" src="" style="width: 156px; height: 157px;"></td>
		</tr>
		<tr>
			<td>Figure-1</td>
			<td>Figure-2</td>
