...
int main(void){
	char* filename1="C:\\Users\\rlatj\\Desktop\\C언어의 정석\\data.bin";
	char* filename2="C:\\Users\\rlatj\\Desktop\\C언어의 정석\\data.txt";
	...
	//data.bin에서 읽기
	printf("= %s = \n",filename1);
	while((ch=fgetc(frb))!=EOF) //fgetc()로 1byte씩 읽어서 출력
		printf("%02X %c\n",ch,ch);
	printf("\n\n");
